...
class Quform_Admin_Page_Forms_Edit extends Quform_Admin_Page
{
    ...
    protected function enqueueStyles()
    {
        ...
        wp_enqueue_style('select2', Quform::url('css/select2.min.css'), array(), '4.0.11');
        ...
        wp_enqueue_style('kendo-common-material', Quform::url('css/kendo.common-material.min.css'), array(), '2019.1.220');
        wp_enqueue_style('kendo-material', Quform::url('css/kendo.material.min.css'), array(), '2019.1.220');
    ...
    protected function enqueueScripts()
    {
        ...
        wp_enqueue_script('jeditable', Quform::adminUrl('js/jquery.jeditable.min.js'), array('jquery'), '2.0.13', true);
        ...
        wp_enqueue_script('select2', Quform::url('js/select2.min.js'), array('jquery'), '4.0.11', true);
        wp_enqueue_script('themecatcher-tabs', Quform::adminUrl('js/tc.tabs.min.js'), array('jquery'), '1.0.0', true);
        wp_enqueue_script('kendo-core', Quform::url('js/kendo.core.min.js'), array('jquery'), '2019.1.220', true);
        wp_enqueue_script('kendo-data', Quform::url('js/kendo.data.min.js'), array('kendo-core'), '2019.1.220', true);
        wp_enqueue_script('kendo-tabstrip', Quform::url('js/kendo.tabstrip.min.js'), array('kendo-data'), '2019.1.220', true);
        wp_enqueue_script('kendo-userevents', Quform::url('js/kendo.userevents.min.js'), array('kendo-core'), '2019.1.220', true);
        wp_enqueue_script('kendo-draganddrop', Quform::url('js/kendo.draganddrop.min.js'), array('kendo-core', 'kendo-userevents'), '2019.1.220', true);
        wp_enqueue_script('kendo-resizable', Quform::url('js/kendo.resizable.min.js'), array('kendo-core', 'kendo-draganddrop'), '2019.1.220', true);
        wp_enqueue_script('kendo-splitter', Quform::url('js/kendo.splitter.min.js'), array('kendo-resizable'), '2019.1.220', true);
