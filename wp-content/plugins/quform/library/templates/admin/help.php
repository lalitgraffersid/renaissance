                ...
                <div class="qfb-box">
                    ...
                    <div class="qfb-content">
                        <div class="qfb-cf qfb-db-about-text">
                            ...
                            <div class="qfb-db-row qfb-cf">
                                <div class="qfb-db-col">
                                    <a class="qfb-db-forum-button" href="https://support.themecatcher.net/"><i class="fa fa-life-ring"></i><?php esc_html_e('Visit help site', 'quform'); ?></a>
                                </div>
                                <div class="qfb-db-col">
                                    <a class="qfb-db-forum-button" href="https://support.themecatcher.net/quform-wordpress-v2/"><i class="fa fa-book"></i><?php esc_html_e('View documentation', 'quform'); ?></a>
                                </div>
                                <div class="qfb-db-col">
                                    <a class="qfb-db-forum-button" href="https://support.themecatcher.net/forums"><i class="fa fa-comments"></i><?php esc_html_e('Support forum', 'quform'); ?></a>
                                </div>
                            </div>
                        </div>
