		...
		public function page_specific_assets() {
			...
			wp_localize_script(
				...
				$this->manager->get_admin_page_config( array(
					...
					'help_links'        => array(
						array(
							'url'   => 'https://crocoblock.com/knowledge-base/articles/creating-custom-post-type-with-jetengine/?utm_source=jetengine&utm_medium=post-type-page&utm_campaign=need-help',
						...
						array(
							...
							'label' => __( 'How to create a custom post type', 'jet-engine' ),
						),
						array(
							'url'   => 'https://crocoblock.com/knowledge-base/articles/jetengine-how-to-display-post-terms-in-admin-columns/?utm_source=jetengine&utm_medium=post-type-page&utm_campaign=need-help',
							'label' => __( 'How to display post terms in admin columns', 'jet-engine' ),
						),
						array(
