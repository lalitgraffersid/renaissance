	...
	<div class="jet-engine-edit-page__fields">
		...
		>
			...
			<div class="cx-vui-panel" slot="content">
				...
				></cx-vui-f-select>
				<cx-vui-f-select
					:label="'<?php _e( 'Specific Posts', 'jet-engine' ); ?>'"
					...
					v-model="generalSettings.allowed_posts"
					ref="allowed_posts"
				></cx-vui-f-select>
				<cx-vui-select
		...
		<jet-meta-fields v-model="metaFields"></jet-meta-fields>
	</div>
