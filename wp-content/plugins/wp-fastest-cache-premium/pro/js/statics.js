var WpFcStatics = {
	...
	wpfc_get_servers: function(){
		...
		var servers = {
					   "na": [
					   		   ...
					   		   {"key": "dal", "time":0,"flag":"us","location":"Dallas","color":"red", "url":"https://api.wpfcdallas.tk"},
	...
	optimize_image: function(self, id, recursive){
		...
		jQuery.ajax({
			...
			url: self.ajax_url,
			dataType : "json",
			data : {"action": "wpfc_optimize_image_ajax_request", "id" : id, "last" : last, "location" : location, "server_url": server_url},
			cache: false,
			timeout: 20000,
			error: function(x, t, m) {
