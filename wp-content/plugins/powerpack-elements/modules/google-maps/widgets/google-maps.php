...
class Google_Maps extends Powerpack_Widget {
    ...
    public function get_title() {
        return __( 'Google Maps', 'powerpack' );
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description'           => sprintf( '<a href="https://mapstyle.withgoogle.com/" target="_blank">%1$s</a> %2$s',__( 'Click here', 'powerpack' ), __( 'to get JSON style code to style your map', 'powerpack' ) ),
				'type'                  => Controls_Manager::TEXTAREA,
                'condition'             => [
                    'map_theme'     => 'custom',
                ],
