    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'description'			=> __( 'Enabled sorting the table data by clicking on the table headers', 'powerpack' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'description'			=> __( 'This will disble stacking and enable swipe/scroll when below breakpoint', 'powerpack' ),
                'type'					=> Controls_Manager::SWITCHER,
                'default'				=> 'no',
                'label_on'				=> __( 'On', 'powerpack' ),
                'label_off'				=> __( 'Off', 'powerpack' ),
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf( __( '%1$s Widget Overview %2$s', 'powerpack' ), '<a href="https://powerpackelements.com/docs/powerpack/widgets/table/table-widget-overview/?utm_source=widget&utm_medium=panel&utm_campaign=userkb" target="_blank" rel="noopener">', '</a>' ),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				/* translators: %1$s doc link */
				'raw'             => sprintf( __( '%1$s How to Extend Cells to Multiple Columns and Rows? %2$s', 'powerpack' ), '<a href="https://powerpackelements.com/docs/powerpack/widgets/table/how-to-extend-cells-to-multiple-columns-and-rows-in-table/?utm_source=widget&utm_medium=panel&utm_campaign=userkb" target="_blank" rel="noopener">', '</a>' ),
				'content_classes' => 'pp-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				/* translators: %1$s doc link */
				'raw'             => sprintf( __( '%1$s How to make Table Sortable? %2$s', 'powerpack' ), '<a href="https://powerpackelements.com/docs/powerpack/widgets/table/how-to-make-any-powerpack-table-sortable/?utm_source=widget&utm_medium=panel&utm_campaign=userkb" target="_blank" rel="noopener">', '</a>' ),
				'content_classes' => 'pp-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				/* translators: %1$s doc link */
				'raw'             => sprintf( __( '%1$s How to setup Table to Display Content? %2$s', 'powerpack' ), '<a href="https://powerpackelements.com/docs/powerpack/widgets/table/how-to-setup-powerpack-table-to-display-content/?utm_source=widget&utm_medium=panel&utm_campaign=userkb" target="_blank" rel="noopener">', '</a>' ),
				'content_classes' => 'pp-editor-doc-links',
			]
		);
                ...
                foreach ( $settings['table_body_content'] as $index => $item ) {
                    if ( $item['table_body_element'] == 'cell' ) {
						...
						if ( ! empty( $item['link']['url'] ) ) {
							$this->add_render_attribute( 'col-link-' . $i, 'href', $item['link']['url'] );
							if ( $item['link']['is_external'] ) {
								$this->add_render_attribute( 'col-link-' . $i, 'target', '_blank' );
							}
							if ( $item['link']['nofollow'] ) {
								$this->add_render_attribute( 'col-link-' . $i, 'rel', 'nofollow' );
							}
						}
