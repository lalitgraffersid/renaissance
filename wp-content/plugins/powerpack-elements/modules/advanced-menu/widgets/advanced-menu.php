...
class Advanced_Menu extends Powerpack_Widget {
	...
	public function get_title() {
		return __( 'Advanced Menu', 'powerpack' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf( __( '%1$s Watch Video Overview %2$s', 'powerpack' ), '<a href="https://www.youtube.com/watch?v=zqmVdbwJKv0&list=PLpsSO_wNe8Dz4vfe2tWlySBCCFEgh1qZj" target="_blank" rel="noopener">', '</a>' ),
