...
class Devices extends Powerpack_Widget {
    ...
    public function get_icon() {
        return 'ppicon-device power-pack-admin-icon';
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf( __( '%1$s Watch Video Overview %2$s', 'powerpack' ), '<a href="https://www.youtube.com/watch?v=r2acXl2Hzak&list=PLpsSO_wNe8Dz4vfe2tWlySBCCFEgh1qZj" target="_blank" rel="noopener">', '</a>' ),
	...
	protected function render_video_buttons() {
		...
		if ( $settings['video_show_buttons'] == 'show' ) {
		?>
